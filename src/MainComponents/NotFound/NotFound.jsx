        ...
        <>
            ...
            <div className="flex flex-col items-center justify-center mx-auto mt-24 max-h-screen min-w-screen">
                ...
                <div className="flex items-center gap-4 mt-6">
                    <Link to={"/Yummies/"} className="bg-[#9d001b] dark:bg-[#3ea575] hover:bg-[#a92a35] dark:hover:bg-emerald-500 px-4 py-2.5 text-white rounded-md active:scale-95 transition-all">
                        Return Home
                    </Link>
