    ...
    return (
        <>
            ...
            <div className='flex flex-col items-center justify-center mx-auto w-full min-h-screen rounded-3xl'>
                <h1 className="mb-12 px-2 py-2 text-center text-red-400 dark:text-white text-3xl font-bold cursor-pointer btn btn-ghost w-max h-max font-['Lobster']">“<Sparkles className="" />Flavors of Every Nation <Sparkles className="" />”</h1>
